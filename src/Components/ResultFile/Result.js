...
const Result = ({ data }) => {
    ...
    return (
        <div className='p-5'>
            ...
            <div className={`${styles.data}  d-flex justify-content-around align-items-center  m-auto text-center`}>
            ...
            <Card className='date-container bg-white p-3  m-auto border-radius-5'>
